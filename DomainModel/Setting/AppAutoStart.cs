...
namespace MSFSPopoutPanelManager.DomainModel.Setting
{
    internal class AppAutoStart
    {
        public static void Activate()
        {
            ...
            var autoStartArg = new LaunchAddOn() { Name = "MSFS Pop Out Panel Manager 2020", Disabled = "false", Path = $@"{Directory.GetCurrentDirectory()}\MSFS Pop Out Panel Manager 2020.exe" };
            ...
            if (filePath != null && File.Exists(filePath))
            {
                ...
                {
                    var autoStartIndex = data.LaunchAddOn.FindIndex(x => x.Name == "MSFS Pop Out Panel Manager");
